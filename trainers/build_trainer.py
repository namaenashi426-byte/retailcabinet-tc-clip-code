...
def load_clip_to_cpu(cfg):
    ...
    design_details = {"vision_model": cfg.get("vision_model", "VisionTransformer"),
                      ...
                      "deterministic_tome": cfg.get("deterministic_tome", False)
                      }
...
def returnCLIP(config, logger=None, class_names=None, return_clip_model=False):
    ...
    if freeze_type is not None:
        ...
        if freeze_type == 'backbone':
            ...
            module_to_update = [
                'text_encoder', 'prompt_learner', 'logit_scale',
                'temporal_delta_head', 'direction_head'
            ]
            ...
            module_to_update = [
                'image_encoder', 'prompt_learner', 'logit_scale',
                'temporal_delta_head', 'direction_head'
            ]
        else:
            raise NotImplementedError
