...
_base_ = r'/path/to/retailcabinet-tc-clip-code/external_baselines/repos/mmaction2/configs/recognition/videomaev2/vit-base-p16_videomaev2-vit-g-dist-k710-pre_16x4x1_kinetics-400.py'
custom_imports = dict(
...
model = dict(backbone=dict(num_frames=clip_len), cls_head=dict(num_classes=num_classes, loss_cls=dict(type='CrossEntropyLoss')), data_preprocessor=dict(type='ActionDataPreprocessor', mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], format_shape='NCTHW'))
